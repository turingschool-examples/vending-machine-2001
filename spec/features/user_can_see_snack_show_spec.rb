...
RSpec.describe "When a user visits the snack show page", type: :feature do
  scenario "they see a list of vending machines" do
    ...
    expect(page).to have_content("#{machine1.name} (3 kinds of snacks, average price of $2.33)")
    expect(page).to have_content("#{machine2.name} (2 kinds of snacks, average price of $1.75)")
  end
end
