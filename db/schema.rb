...
ActiveRecord::Schema.define(version: 20200410154529) do
  ...
  create_table "machines", force: :cascade do |t|
    ...
    t.bigint "snack_id"
    t.bigint "machine_id"
    t.index ["machine_id"], name: "index_machines_on_machine_id"
  ...
  create_table "snacks", force: :cascade do |t|
    ...
    t.index ["snack_id"], name: "index_snacks_on_snack_id"
  end

  add_foreign_key "machines", "machines"
  add_foreign_key "machines", "owners"
  add_foreign_key "machines", "snacks"
  add_foreign_key "snacks", "machines"
  add_foreign_key "snacks", "snacks"
end
